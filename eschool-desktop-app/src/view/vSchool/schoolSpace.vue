...
>>>>>>> 5d4c4896725fead25d7216c5593236afa25e3d86
                            </div>
                        </List>
                    </div>
                </perfect-scrollbar>
            ...
            <TabPane label="应用">
                <perfect-scrollbar>
                    <div class="p-3">
                        <div class="p-scroll">
                            <div
                                v-for="(menu, i) in menuLists.application"
                                :key="i"
                            >
                        ...
                        <div class="p-scroll">
                            <div v-for="(menu, i) in menuLists.member" :key="i">
                                ...
                                <div
                                    v-else-if="i < 6"
                                    class="es-item"
                                    v-for="(subMenu, j) in menu.subMenuLists"
                                    :key="j"
                                >
            ...
            <template slot="extra">
                <Button class="btnclass" @click="addModal"
                    ><Icon type="md-add" /> 发布
                </Button>
            </template>
        </Tabs>
...
export default {
    ...
    methods: {
        async clickLike(item) {
            ...
            const res = await this.callApi("put", "api/isLiked", {
                id: item.id,
        ...
        infiniteHandler($state) {
            ...
            setTimeout(() => {
                let vm = this;
                window.axios
                    .get("api/allPost?page=" + this.page)
                    .then(({ data }) => {
